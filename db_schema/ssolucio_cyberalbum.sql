...
(22, 'multiple', 'en', 'These are vulnerability classes:', '["Deliberate, Accidental", "Network, Place", "Hardware,Software", "Staff, Organization"]', '[1, 2, 3]', 2.3, 'Vulnerability classes include those related to hardware, software, and personal or organizational aspects. It is crucial to identify and address each one to maintain information security.');
...
(22, 'multiple', 'es', 'Son clases de vulnerabilidades:', '["Deliberada, Accidental ", "Red, Lugar", "Hardware, Software", "Personal, Organizaci\u00f3n"]', '[1, 2, 3]', 2.3, 'Las clases de vulnerabilidades incluyen las relacionadas con hardware, software y las personales u organizacionales. Es crucial identificar y abordar cada una para mantener la seguridad de la información.');
