...
(1, 'multiple', 'en', 'What is security?', '["Related to trust", "The opposite of insecurity", "Necessity of the human being", "State of being free from danger"]', '[0,1,3]', 1.4, 'The security is the foundation of trust and a fundamental human need.'),
...
(3, 'single', 'en', 'Cybersecurity protects information in:', '["Digital format and interconnected systems", "Interconnected formats and digital systems", "Virtual environments", "Cyberspace"]', '[0]', 2.1, 'This entails securing digitally stored data as well as protecting computer systems and networks that facilitate communication and information exchange.'),
(4, 'multiple', 'en', 'Which of these are information assets?', '["Web page", "Customer Emails", "Door lock of the Computing Center", "Written Documentation"]', '[0, 1, 3]', 2.4, 'Information assets are crucial elements for an organization and can exist in various forms.'),
...
(7, 'single', 'en', 'Which of these pillars is NOT information security:', '["Availability", "Authenticity", "Integrity", "Confidentiality"]', '[1]', 0.7, 'The three pillars of information security are: confidentiality, integrity, and availability.'),
...
(11, 'multiple', 'en', 'What are the impacts that a computer attack can cause in a corporation?', '["Financial", "Reputational", "Legal", "Ambiental"]', '[0, 1, 2]', 2.1, 'A cyber attack can cause financial, reputational, and legal impacts on an entity. It is crucial to be prepared to prevent and manage these situations.'),
...
(22, 'multiple', 'en', 'These are vulnerability classes:', '["Deliberate, Accidental", "Internal, External", "Hardware, Software", "Staff, Organization"]', '[2, 3]', 3.0, 'Vulnerability classes include those related to hardware, software, and personal or organizational aspects. It is crucial to identify and address each one to maintain information security.');

-- Insertando las preguntas en inglés
INSERT INTO question (question_id, type, lang, question, options, solution, difficulty, feedback) VALUES
(1, 'single', 'es', '¿Qué es seguridad?', '["Relativo a confianza", "Lo contrario de inseguridad", "Necesidad del ser humano", "Estado de estar libre de peligro"]', '[0,1,3]', 1.4, 'La seguridad es la base de la confianza y una necesidad humana fundamental.'),
...
(3, 'single', 'es', 'La ciberseguridad protege información en:', '["Formato digital y sistemas interconectados", "Formatos interconectados y sistemas digitales", "Ambientes virtuales", "Espacio Cibernético"]', '[0]', 2.1, 'Esto implica asegurar los datos almacenados digitalmente, así como proteger los sistemas informáticos y las redes que facilitan la comunicación y el intercambio de información.'),
(4, 'multiple', 'es', '¿Cuál de estos son activos de información?', '["Pagina web", "Correos electrónicos de clientes", "Cerradura del Centro de Cómputo", "Documentación escrita"]', '[0, 1, 3]', 2.4, 'Los activos de información son elementos cruciales para una organización y pueden existir en diversas formas.'),
...
(7, 'single', 'es', 'Cuál de estos pilares, NO es de seguridad de información:', '["Disponibilidad", "Autenticidad", "Integridad", "Confidencialidad"]', '[1]', 0.7, 'Los 3 pilares de seguridad de la información son: confidencialidad, integridad y disponibilidad.'),
...
(11, 'multiple', 'es', 'Cuáles son los impactos que puede causar un ataque informático en una entidad?', '["Financiero", "Reputacional", "Legal", "Ambiental"]', '[0, 1, 2]', 2.1, 'Un ataque informático puede causar impactos financieros, reputacionales y legales en una entidad. Es crucial estar preparados para prevenir y gestionar estas situaciones.'),
...
(22, 'multiple', 'es', 'Son clases de vulnerabilidades:', '["Deliberada, Accidental ", "Interna, Externa", "Hardware, Software", "Personal, Organización"]', '[2, 3]', 3.0, 'Las clases de vulnerabilidades incluyen las relacionadas con hardware, software y las personales u organizacionales. Es crucial identificar y abordar cada una para mantener la seguridad de la información.');
